...
- [Daily build](https://shmsoft.s3.amazonaws.com/releases/freeeed_complete_pack-10.8.3-SNAPSHOT.zip) *(unstable)*
- [Daily build of Windows Installer](https://shmsoft.s3.us-east-1.amazonaws.com/releases/FreeEed-10.8.3-SNAPSHOT-Windows.exe) *(unstable)*
- [Daily build of Linux Installer](https://shmsoft.s3.us-east-1.amazonaws.com/releases/FreeEed-10.8.3-SNAPSHOT-Linux.run) *(unstable)*
